...
public class JwtService {
    ...
    public String generateToken(final AbstractUser user) {
        return buildToken(user, jwtExpiration);
    }

    public String generateRefreshToken(final AbstractUser user) {
        return buildToken(user, refreshExpiration);
    }

    private String buildToken(final AbstractUser user, final long expiration) {
        return Jwts
                .builder()
